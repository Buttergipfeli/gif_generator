...
class AppColors {
  // Light mode
  static const Color lightLightGreen = Color(0xFF49DB5B);
  static const Color lightLightGreenAccent = Color(0xFF80F2AD);
  static const Color lightDarkGreenAccent = Color(0xFF32B07C);
  ...
  static const Color darkLightGreenAccent = Color(0xFF3CA275);
  static const Color darkDarkGreenAccent = Color(0xFF2E888A);
